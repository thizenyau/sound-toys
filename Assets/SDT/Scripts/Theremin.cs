...
namespace Theremin
{
  ...
  public float _out1 = 0;  
        private float _pitch1 = 0;
        private float _volume1 = 0;
   ...
   //_headPosition =head.transform.position;
            ...
            _volume1 = _headToFeet / headToFeetDistance;




            _csound.SetChannel("Frequency", CsoundUnity.Remap(_pitch1, 0f, 1f, _freqRange.x, _freqRange.y, true));
            _csound.SetChannel("Amplitude", CsoundUnity.Remap(_volume1, 0f, 1f, 0f, 1f, true));
        }
    }
}